...
namespace WebApplication1.Controllers
{
    ...
    [ApiController]
    public class EspSerialActivesController : ControllerBase
    {
        private readonly Smart_Api_DBContext _context;

        public EspSerialActivesController(Smart_Api_DBContext context)
        {
            _context = context;
        }

        // GET: api/EspSerialActives
        [HttpGet]
